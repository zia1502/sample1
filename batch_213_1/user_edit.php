        ...
        <div class="col-md-12">
            ...
            <form action="" method='post'>
              ...
              <div class="mb-3 mt-3">
                ...
                <input type="text" class="form-control" id="name" placeholder="Enter name" name="name" value="<?php echo (isset($user_data_info->name) && !empty($user_data_info->name) ? $user_data_info->name : '') ?>">
              </div>


              <div class="mb-3 mt-3">
                <label for="email" class="form-label">Email:</label>
                <input type="email" class="form-control" id="email" placeholder="Enter email" name="email" value="<?php echo (isset($user_data_info->email) && !empty($user_data_info->email) ? $user_data_info->email : '') ?>">
              </div>
